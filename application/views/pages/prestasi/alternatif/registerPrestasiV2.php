						...
						<div class="row justify-content-center">
							...
							<div class="col-md-7 ml-4">
								...
								<div class="form-group">
									<input type="text" name="" class="form-control" placeholder="Nama Prestasi" id="">
								</div>
								<div class="form-group">
									<input type="text" name="" class="form-control" placeholder="Tingkat Prestasi" id="">
								</div>
								<div class="form-group">
									<textarea name="" class="form-control" placeholder="Keterangan (Jenis lomba, Tempat Pelaksanaan, Tingkat Lomba, Pencapaian)" id="" cols="30" rows="10"></textarea>
									<!-- <input type="comtextment" name="" class="form-control" placeholder="Jenis Lomba" id=""> -->
								</div>
