...
--
-- Host: localhost
-- Generation Time: Jul 03, 2020 at 01:58 PM
...
--
-- Table structure for table `calon_mapres`
--

CREATE TABLE `calon_mapres` (
  `nim` char(255) NOT NULL,
  `file_kti` text NOT NULL,
  `tahun` text NOT NULL,
  `status` text NOT NULL,
  `skor_toefl` text NOT NULL
...
--
-- Indexes for table `calon_mapres`
--
ALTER TABLE `calon_mapres`
  ADD KEY `calon_mapres_nim_fkey` (`nim`);
...
--
-- Constraints for table `calon_mapres`
--
ALTER TABLE `calon_mapres`
  ADD CONSTRAINT `calon_mapres_nim_fkey` FOREIGN KEY (`nim`) REFERENCES `mahasiswa` (`nim`);
